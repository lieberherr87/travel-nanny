...
user1 = User.create(first_name:"Steffen", last_name: "Rudishüli", email: "test@mail.com", password: "password", image: "anne_vfchqv.jpg")
user2 = User.create(first_name:"Bani", last_name: "Vanani", email: "test2@mail.com", password: "password", image: "seb_cjnhku.jpg")
user3 = User.create(first_name:"Hanna", last_name: "Montana", email: "test3@mail.com", password: "password", image: "romain_ryjgyd.jpg")
